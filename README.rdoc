...
You can also add this to your test set up code (making sure it runs in process with your tests):
    ...
    puts "Random seed was #{seed}"

You can then set +RANDOM_SEED+ in your environment to recreate a specific test.
